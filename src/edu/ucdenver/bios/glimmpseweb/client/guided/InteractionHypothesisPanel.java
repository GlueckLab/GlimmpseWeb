...
public class InteractionHypothesisPanel extends Composite
{
	...
	public InteractionHypothesisPanel()
	{
		...
		betweenParticipantFactors.setText(GlimmpseWeb.constants.interactionHypothesisPanelBetweenParticipantFactors());
		withinParticipantFactors.setText(GlimmpseWeb.constants.interactionHypothesisPanelWithinParticipantFactors());
	...
	public void test()
	{
		...
		{
			betweenParticipantFactorsFlexTable.setWidget(i, 0, new InteractionVariablePanel(betweenParticipantFactorDataList.get(i)));
		}
		...
		{
			withinParticipantFactorsFlexTable.setWidget(i, 0, new InteractionVariablePanel(withinParticipantFactorDataList.get(i)));
