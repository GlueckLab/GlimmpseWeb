...
/* $TARGET_EMAIL = array(EMAIL_NAME."^sarah\.kreidler@ucdenver\.edu$"); */
$TARGET_EMAIL = array("^sarah\.kreidler@ucdenver\.edu$");
	
            /* Help: http://www.tectite.com/fmdoc/def_alert.php */
define("DEF_ALERT","sarah\.kreidler@ucdenver\.edu");
...
function LoadBuiltinLanguage()
{
    ...
    $aMessages[MSG_LOG_OK] = 'OK';
        ...
        // Parameters: none
    $aMessages[MSG_THANKS_PAGE] = 'Thank you for your comments.  We\'ve received your information.';
